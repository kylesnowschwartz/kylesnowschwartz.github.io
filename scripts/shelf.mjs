...
import { EXIT } from './shelf/output.mjs';
...
program
  ...
  .action(lazy('./shelf/cmd-fetch.mjs', 'run'));
...
program
  ...
  .action(lazy('./shelf/cmd-add.mjs', 'run'));
...
program
  ...
  .addHelpText('after', '\nExample:\n  $ shelf enrich')
  .action(lazy('./shelf/cmd-enrich.mjs', 'run'));
...
program
  ...
  .addHelpText('after', '\nExample:\n  $ shelf embed')
  .action(lazy('./shelf/cmd-embed.mjs', 'run'));
...
program
  ...
  .addHelpText('after', '\nExample:\n  $ shelf build')
  .action(lazy('./shelf/cmd-build.mjs', 'run'));
...
program
  ...
  .action(lazy('./shelf/cmd-next.mjs', 'run'));
