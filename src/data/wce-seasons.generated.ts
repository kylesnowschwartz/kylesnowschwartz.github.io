...
export const LEAGUE_DATA: Record<number, SeasonData> = {
  ...
  2006: {
    ...
    lastPlace: "BATMAN",
    lastPlaceMgr: "Kyle",
    note: "Ben Walker won 2006 with Team Weak. Yahoo ranks Beantown Ballers first, and both teams finished 8-6, so Yahoo's tiebreak between them is where the record went wrong."
  },
  2007: MISSING_YEAR,
  2008: MISSING_YEAR,
  2009: MISSING_YEAR,
  ...
  2012: { champion: "Mohawk National", championMgr: "McLean", record: "9-5", lastPlace: "TheTheobaldWolftones", lastPlaceMgr: "Conway" },
  ...
  2022: { champion: "Koala lambpork", championMgr: "THomas", record: "9-6", lastPlace: "F.U.B.A.R.", lastPlaceMgr: "Conway" },
...
export const TEAMS: Team[] = [
  ...
  { name: "F.U.B.A.R.", manager: "Conway", wins: 9, losses: 6 },
