...
- I prototyped the consolidation of Envato's four Dependabot-triage systems into two layers—an SLA tracker and an AI remediation pipeline. In doing so I discovered a mechanical solution to a problem otherwise solved by the LLM, cutting per-review cost by roughly **95%** in live runs.
...
Modernized a 15-year-old Rails marketplace serving millions of users—Rails 4.x through 7.x with zero-downtime. Our 12-month handover of the platform to a contracting team was completed in less than 8 months due to AI-assisted workflows I helped introduce. From May 2025, focus shifted to the AI adoption and enablement work above.
